...
const PAGES: Record<string, { title: string; body: string[] }> = {
  privacy: {
    ...
    body: [
      ...
      "Export your data at any time from the app (JSON). Erase your account and all events from the same screen. Email sarmaasis@gmail.com for a human request. We use Cloudflare (Workers, D1, Email Sending) as infrastructure. Billing for a Cairn subscription uses Dodo Payments. Optional processors you connect: Stripe, Polar, Paddle, Lemon Squeezy, Google Search Console, Bing Webmaster.",
    ],
  },
  terms: {
    title: "Terms",
